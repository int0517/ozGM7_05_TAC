...
public static class BackgroundTreePlacementTool
{
    ...
    private static readonly TreePlacement[] Placements =
    {
        ...
        new(-27.0f, -18.25f, 2, 0.95f, false),
        new(-22.0f, -17.75f, 0, 0.9f, true),
        new(-17.0f, -18.25f, 1, 0.95f, false),
        new(-12.0f, -17.75f, 2, 0.85f, true),
        new(-7.0f, -18.25f, 0, 0.9f, false),
        new(-2.0f, -17.75f, 1, 0.95f, true),
        new(3.0f, -18.25f, 2, 0.85f, false),
        new(8.0f, -17.75f, 0, 0.9f, true),
        new(13.0f, -18.25f, 1, 0.95f, false),
        new(18.0f, -17.75f, 2, 0.85f, true),
        new(23.0f, -18.25f, 0, 0.9f, false),
        new(27.0f, -17.75f, 1, 0.95f, true),
        new(-27.0f, 16.5f, 1, 0.95f, true),
        new(-22.0f, 16.0f, 2, 0.85f, false),
        new(-17.0f, 16.5f, 0, 0.9f, true),
        new(-12.0f, 16.0f, 1, 0.95f, false),
        new(-7.0f, 16.5f, 2, 0.85f, true),
        new(-2.0f, 16.0f, 0, 0.9f, false),
        new(3.0f, 16.5f, 1, 0.95f, true),
        new(8.0f, 16.0f, 2, 0.85f, false),
        new(13.0f, 16.5f, 0, 0.9f, true),
        new(18.0f, 16.0f, 1, 0.95f, false),
        new(23.0f, 16.5f, 2, 0.85f, true),
        new(27.0f, 16.0f, 0, 0.9f, false),
        new(-27.5f, -13.0f, 0, 0.9f, true),
        new(-27.0f, -9.0f, 1, 0.95f, false),
        new(-27.5f, -5.0f, 2, 0.85f, true),
        new(-27.0f, -1.0f, 0, 0.9f, false),
        new(-27.5f, 3.0f, 1, 0.95f, true),
        new(-27.0f, 7.0f, 2, 0.85f, false),
        new(-27.5f, 11.0f, 0, 0.9f, true),
        new(27.5f, -13.0f, 1, 0.95f, false),
        new(27.0f, -9.0f, 2, 0.85f, true),
        new(27.5f, -5.0f, 0, 0.9f, false),
        new(27.0f, -1.0f, 1, 0.95f, true),
        new(27.5f, 3.0f, 2, 0.85f, false),
        new(27.0f, 7.0f, 0, 0.9f, true),
        new(27.5f, 11.0f, 1, 0.95f, false),
        new(-24.5f, -18.5f, 1, 0.9f, true),
        new(-19.5f, -18.0f, 2, 0.85f, false),
        new(-14.5f, -18.5f, 0, 0.95f, true),
        new(-9.5f, -18.0f, 1, 0.9f, false),
        new(-4.5f, -18.5f, 2, 0.85f, true),
        new(0.5f, -18.0f, 0, 0.95f, false),
        new(5.5f, -18.5f, 1, 0.9f, true),
        new(10.5f, -18.0f, 2, 0.85f, false),
        new(15.5f, -18.5f, 0, 0.95f, true),
        new(20.5f, -18.0f, 1, 0.9f, false),
        new(25.0f, -18.5f, 2, 0.85f, true),
        new(29.0f, -18.0f, 0, 0.95f, false),
        new(-24.5f, 16.75f, 2, 0.85f, false),
        new(-19.5f, 16.25f, 0, 0.95f, true),
        new(-14.5f, 16.75f, 1, 0.9f, false),
        new(-9.5f, 16.25f, 2, 0.85f, true),
        new(-4.5f, 16.75f, 0, 0.95f, false),
        new(0.5f, 16.25f, 1, 0.9f, true),
        new(5.5f, 16.75f, 2, 0.85f, false),
        new(10.5f, 16.25f, 0, 0.95f, true),
        new(15.5f, 16.75f, 1, 0.9f, false),
        new(20.5f, 16.25f, 2, 0.85f, true),
        new(25.0f, 16.75f, 0, 0.95f, false),
        new(29.0f, 16.25f, 1, 0.9f, true),
        new(-28.25f, -15.0f, 1, 0.9f, false),
        new(-28.0f, -11.0f, 2, 0.85f, true),
        new(-28.25f, -7.0f, 0, 0.95f, false),
        new(-28.0f, -3.0f, 1, 0.9f, true),
        new(-28.25f, 1.0f, 2, 0.85f, false),
        new(-28.0f, 5.0f, 0, 0.95f, true),
        new(-28.25f, 9.0f, 1, 0.9f, false),
        new(28.25f, -15.0f, 2, 0.85f, true),
        new(28.0f, -11.0f, 0, 0.95f, false),
        new(28.25f, -7.0f, 1, 0.9f, true),
        new(28.0f, -3.0f, 2, 0.85f, false),
        new(28.25f, 1.0f, 0, 0.95f, true),
        new(28.0f, 5.0f, 1, 0.9f, false),
        new(28.25f, 9.0f, 2, 0.85f, true),
    };
