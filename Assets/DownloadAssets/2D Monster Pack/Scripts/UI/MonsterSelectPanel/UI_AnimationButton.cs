...
{
    public class UI_AnimationButton : MonoBehaviour
    {
        ...
        UnityAction<UI_AnimationButton> _action;
        public void AddListener_OnClick(UnityAction<UI_AnimationButton> action) => _action = action;
